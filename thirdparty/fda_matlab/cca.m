function [ccafdPar1, ccfdPar2, ccavar1, ccavar2, corrs] = ...
              cca_fd(fdobj1, fdobj2, ncan, ccafdPar1, ccfdPar2)
...
%
%  This function is essentially the same as cca_fd
...
wtfd1     = fd(canwtcoef1, fdbasis1, fdnames1);
wtfd2     = fd(canwtcoef2, fdbasis2, fdnames2);
ccafdPar1 = putfd(ccafdPar1, wtfd1);
ccafdPar2 = putfd(ccafdPar2, wtfd2);
